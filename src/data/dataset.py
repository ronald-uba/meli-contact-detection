...
PROMPT_TEMPLATE = (
    ...
    "Mark has_contact_data=1 ONLY if the listing contains: phone numbers, emails, WhatsApp "
    "numbers, external URLs (non-MeLi domains), social media handles (@user), physical "
    "addresses, or explicit invitations to contact outside Mercado Libre.\n\n"
    "Do NOT mark as contact data:\n"
    "- Links to Mercado Libre / Mercado Livre pages "
    "(mercadolibre.com, mercadolivre.com.br, mlstatic.com).\n"
